...
import { AutoAwesome, Collections, ViewStream } from '@mui/icons-material';
...
const Aluminium = () => {
    ...
    useEffect(() => {
        setProducts(storage.getAluminiumProducts());
    }, []);
                    ...
                    >
                        <Box sx={{ textAlign: 'center' }}>
                            ...
                            <Typography variant="h1" fontWeight="900" sx={{ mb: 2, fontSize: { xs: '2.5rem', md: '4.2rem' }, lineHeight: 1.1 }}>
                                Precision <span style={{ color: '#14B8A6' }}>Aluminium</span> Fabrication
                            </Typography>
                            <Typography variant="h6" sx={{ opacity: 0.8, fontWeight: 400, maxWidth: 700, mx: 'auto', lineHeight: 1.6 }}>
                                High-performance aluminium solutions engineered for modern architectural excellence and lifelong durability.
                            </Typography>
                        </Box>
                    </motion.div>
                </Container>
            ...
            <Box sx={{
                ...
                <Container maxWidth="lg">
                    <Box sx={{
                        ...
                        {['All', ...storage.ALUMINIUM_CATEGORIES].map((cat) => (
                            <Button
                                key={cat}
                    ...
                    >
                        {selectedCategory === 'All' ? (
                            <>
                                ...
                                {storage.ALUMINIUM_CATEGORIES.map(category => (
                ...
                {products.length === 0 && (
                    <Box sx={{ textAlign: 'center', py: 15, bgcolor: '#f8fafc', borderRadius: 8, border: '2px dashed #e2e8f0' }}>
                        ...
                        <Typography variant="body1" color="text.secondary">
                            Please check back soon for our latest aluminium products.
                        </Typography>
                    </Box>
                )}
            </Container>
